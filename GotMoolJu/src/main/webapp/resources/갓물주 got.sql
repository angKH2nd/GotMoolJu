...
CREATE TABLE TB_IMPROVEMENT (
    ...
    IMP_REPLY_LIKES NUMBER DEFAULT 0,
    IMP_REPLY_DISLIKES NUMBER DEFAULT 0,
...
COMMENT ON COLUMN TB_IMPROVEMENT.IMP_REPLY_LIKES IS '개선의견 좋아요 수';
COMMENT ON COLUMN TB_IMPROVEMENT.IMP_REPLY_DISLIKES IS '개선의견 싫어요 수';
