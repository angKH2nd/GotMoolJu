...
COMMENT ON COLUMN TB_TOWN.TOWN_REPLY_NO IS '동네소식 댓글 번호';
COMMENT ON COLUMN TB_TOWN.TOWN_REPLY_REF_NO IS '동네소식 번호';
COMMENT ON COLUMN TB_TOWN.TOWN_REPLY_WRITER IS '동네소식 댓글 작성자';
COMMENT ON COLUMN TB_TOWN.TOWN_REPLY_WRITER_IMG IS '동네소식 댓글 작성자 프로필';
COMMENT ON COLUMN TB_TOWN.TOWN_REPLY_CONTENT IS '동네소식 댓글 내용';
COMMENT ON COLUMN TB_TOWN.TOWN_REPLY_CREATE_DATE IS '동네소식 댓글 작성일';
COMMENT ON COLUMN TB_TOWN.TOWN_REPLY_MODIFY_DATE IS '동네소식 댓글 수정일';
